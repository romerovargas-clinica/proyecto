    ...
    <table class="table table-striped table-sm table-hover">
      ...
      ?>
            <tr class="tbl-h<?= $class ?>"
                onclick="window.location='admin.php?section=professionals&page=<?= ($page) ?>&edit=<?= $recordT['id'] ?>';">
                <td><?= $recordT["id"] ?></td>
                ...
                <td><?= $recordT["info"] ?></td>
                <td class="" style="">
                    <?= $recordT["enabled"] == 1 ? __('Case_Enable', $lang) : __('Case_Disable', $lang) ?></td>
            </tr>
            <?php
...
<div class="container-md border position-relative p-3">
    <button type="button" class="btn-close p-3 position-absolute top-0 end-0" aria-label="Close" onclick="frm_close()"
        data-bs-toggle="tooltip" data-bs-placement="bottom" title="<?= __('btn_Close', $lang) ?>"></button>
    <form id="opinionsAddform" action="admin.php?section=professionals&page=<?= $page ?>" method="POST">
        ...
        <div class="mb-6 row">
            ...
            <div class="col-sm-6">
                <div class="card-img-top"><img src="images/blank.png" class="crop rounded d-block" alt="" height="50"
                        onclick="changeImg();" id="img_base"></div>
...
<div class="container-md border position-relative p-3">
    <button type="button" class="btn-close p-3 position-absolute top-0 end-0" aria-label="Close" onclick="frm_close()"
        data-bs-toggle="tooltip" data-bs-placement="bottom" title="<?= __('btn_Close', $lang) ?>"></button>
    <form id="opinionsEditform"
        action="admin.php?section=professionals&page=<?= $page ?>&edit=<?= $_GET['edit'] ?>#form" method="POST">
        ...
        <div class="mb-6 row">
            ...
            $_img = "images/uploads/" . $fields[0]["image"];
                ...
                <div class="card-img-top"><img src="<?= $_img ?>" class="crop rounded d-block" alt="" height="50"
                        onclick="changeImg();" id="img_base"></div>
        ...
        <div class="mb-6 row">
            <label for="inputInfo" class="col-sm-2 col-form-label"><?= __('frm_Desc', $lang) ?></label>
            <div class="col-sm-6">
                <textarea class="form-control form-control-sm" name="inputInfo" id="inputInfo"
                    required><?= $fields[0]["info"] ?></textarea>
            </div>
        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary"
                    data-bs-dismiss="modal"><?= __('btn_Close', $lang) ?></button>
