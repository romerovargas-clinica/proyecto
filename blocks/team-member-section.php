...
?>
<!-- ========================= team-section start ========================= -->
<section id="team" class="team-section pt-50 pb-150">
    ...
    <div class="row">
      <div class="col-xl-8 mx-auto">
        <div class="section-title text-center mb-55">
          ...
          $professionals = $db->select("professionals", $where); ?>
          <span class="wow fadeInDown" data-wow-delay=".2s"><?= __($result[0]["title"], $lang) ?></span>
          <?php
          if (count($professionals) == 1) : ?>
            <h2 class="mb-15 wow fadeInUp" data-wow-delay=".4s"><?= __($professionals[0]["name"], $lang) ?></h2>
            <div class="row">
              <div class="col-6">
              <div class="team-img mb-50">
                <img src="images/uploads/<?= $professionals[0]['image'] ?>" alt="">
              </div>
              </div>
              <div class="col-6">
              <p class="wow fadeInUp" data-wow-delay=".6s"><?= __($professionals[0]["info"], $lang) ?></p>
              </div>
            </div>
            ...
            <div class="row">
              <div id="customize_wrapper">
                <div class="customize-tools">
                  <ul style="margin-top:80px" class="thumbnails d-flex justify-content-center" id="customize-thumbnails">
                    <?php
                    $professionals = $db->select("professionals", "enabled = 1");
                    if ($professionals) :
                      foreach ($professionals as $person) : ?>
                        <li style="margin-left:10px">
                          <?php if (file_exists("images/uploads/" . $person["image"])) : ?>
                            <a href="team.php?id=<?= $person["id"] ?>"><img class="testimonial-section thumbnails li img" src="images/uploads/<?= $person["image"] ?>" alt="" height="80"></a>
                          <?php else : ?>
